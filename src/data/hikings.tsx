export const hikings = [
  ...
  },
  {
    ...
    hikes: [
      { startDate: '2025-4-12', endDate: '2025-4-14' },
  ...
  {
    title: 'คลุยหลวง จอวาเล ทูเล',
    hikes: [{ startDate: '2025-10-11', endDate: '2025-10-13' }],
    distance: 15.0,
  },
  {
    title: 'เขาช้างเผือก',
    hikes: [
      ...
      { startDate: '2025-12-23', endDate: '2025-12-24' },
    ],
    distance: 8.0,
  },
  {
    title: 'ดอยหลวงเชียงดาว',
    hikes: [{ startDate: '2026-01-04', endDate: '2026-01-05' }],
    distance: 8.0,
  },
];
