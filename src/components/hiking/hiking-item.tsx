...
export default function HikingItem({ item, stravaActivity }: HikingItemProps) {
  return (
    <div className='group rounded-xl border border-border/50 bg-card p-5 hover:border-border transition-all duration-200'>
        ...
        <div className='flex-1'>
          ...
          {stravaActivity && (
            <div className='mt-4 flex flex-col sm:flex-row gap-4'>
              {stravaActivity.map && (
                <div className='w-full sm:w-48 shrink-0 rounded-lg overflow-hidden'>
                  <RouteMap
              ...
              <div className='flex flex-wrap content-start gap-x-6 gap-y-3 text-xs py-1'>
        ...
        <div className='flex flex-col items-end gap-2'>
          ...
          {stravaActivity && (
            <Link
              ...
              target='_blank'
              className='text-xs text-[#fc4c02] hover:underline flex items-center gap-1 mt-1'
            >
              View on Strava &rarr;
            </Link>
          )}
