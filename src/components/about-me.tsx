  ...
  return (
    <section className='max-w-5xl mx-auto px-6 md:px-4 my-20'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
        <div className='flex flex-col gap-6 border p-6 rounded-lg bg-card group'>
        ...
        <div className='flex flex-col gap-6 border p-6 rounded-lg bg-card group col-start-1 md:col-end-3'>
          <div className='aspect-[3/1.5] relative max-h-56'>
            <Image
              fill
              src='/contact.png'
              alt='contact'
